...
**Live → https://baditaflorin.github.io/mesh-handshake-chain/**

**Source → https://github.com/baditaflorin/mesh-handshake-chain**
...
git clone https://github.com/baditaflorin/mesh-handshake-chain
...
- `mesh-handshake-chain:signalingUrl`
- `mesh-handshake-chain:turnTokenUrl`
- `mesh-handshake-chain:iceServers`
- `mesh-handshake-chain:room`
